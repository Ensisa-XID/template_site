...
<html lang="fr">
  <head>
    ...
    <title>Erreur 401 &mdash; XID</title>
    <meta name="author" content="xid" />
  ...
  <body>
        <header>
            <h1><a href="/" title="XID">XID</a></h1>
		</header>
	 
	 <div id="content">
	<article>
	  <h2>Erreur 401 : Non Autorisé — Unauthorized</h2>
	  <h3>L’accès à la ressource n’est pas autorisé car le serveur exige une identification de l’utilisateur.</h3>
	...
	<footer>
            <p>
                <span><a href="http://xid.ensisa.info/">XID</a>
